...
## Project Structure
    ...
    ├── documentation_chat__44220  # Django project configurations
...
1. Clone this repo and `cd documentation_chat__44220`
...
2. Clone this repo and `cd documentation_chat__44220`
